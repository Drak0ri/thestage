...
const Storage = {
  ...
  load() {
    try {
      ...
      if (!raw) return { team: [], chatHistory: {}, briefing: '', conversations: {}, stageIds: [], stageTalkingId: null };
      return JSON.parse(raw);
    } catch(e) { return { team: [], chatHistory: {}, briefing: '', conversations: {}, stageIds: [], stageTalkingId: null }; }
  },
